...
module.exports = function online()
{
  ...
  var settings = {needle: {open_timeout: 5000, read_timeout: 5000}};

  return new Promise(function(resolve)
  {
    __logger__.log('Checking online status.');
    needle.get('https://api.ipify.org', settings.needle, function(error, response)
    {
      ...
      {
        __logger__.log('Online');
        resolve(true);
      }
      else
      {
        __logger__.warn('Offline');
        resolve(false);
      }
    });
  });
